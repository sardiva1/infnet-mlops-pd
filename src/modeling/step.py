...
Implementa PipelineStep para orquestrar toda a experimentação:
  Entrada : data/features/car_price_features.parquet (gerado por preprocessamento.py)
...
class ModelingStep(PipelineStep):
    ...
    def run(self) -> None:
        ...
        tracker   = MLflowTracker(
            ...
            experiment_name=self._modeling_cfg.get('experiment_name', 'car-pricing-experiments'),
        ...
        registry_name = self._modeling_cfg.get('registry_name', 'car-pricing-best')
    ...
    def _carregar_features(self) -> tuple[pd.DataFrame, pd.Series]:
        ...
        features_file = features_dir / features_cfg.get('features_filename', 'car_price_features.parquet')
        ...
        target_col = sel_cfg.get('target', 'Price')
