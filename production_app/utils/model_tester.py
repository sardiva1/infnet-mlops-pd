...
# ── Bootstrap de paths - garante acesso a src/ independentemente do CWD ──────
...
# Ajustar CWD para projeto root se necessário
if os.getcwd() != str(_PROJECT_ROOT):
    os.chdir(_PROJECT_ROOT)

from src.modeling.metrics import calcular_metricas
from production_app.utils.pipeline_utils import preprocessar_entradas
...
class ModelTester:
    ...
    def prever_manual(self, features_dict: dict[str, Any]) -> dict[str, Any]:
        ...
        ----------
        features_dict : dict
            Dicionário com as features BRUTAS do carro:
            {
                'Brand': 'Toyota',
                'Model_Year': 2020,
                'Engine_Size': 2.0,
        ...
        dict com chaves:
            ...
            - 'features_brutas': dict - Features brutas fornecidas
            - 'features_preprocessadas': dict - Features após preprocessamento
        ...
        try:
            # Preprocessar as features brutas
            df_features = preprocessar_entradas(features_dict)
            ...
            resultado = {
                ...
                'features_brutas': features_dict,
                'features_preprocessadas': df_features.to_dict('records')[0],
    ...
    def prever_interativo(self) -> dict[str, Any]:
        """
        Interface interativa para o usuário inserir features brutas e fazer uma predição.
        ...
        print("\n" + "=" * 70)
        print("PREDIÇÃO INTERATIVA - Insira as features do carro")
        print("=" * 70)
        ...
        return self.prever_manual(features_brutas)
    ...
    def relatorio_predicao_manual(self, resultado_predicao: dict[str, Any]) -> str:
        ...
        linhas = [
            ...
            f"",
            f"FEATURES BRUTAS (entrada do usuário):",
        ]

        for chave, valor in resultado_predicao.get('features_brutas', {}).items():
            linhas.append(f"  {chave}: {valor}")

        linhas.extend([
            f"",
            f"FEATURES PREPROCESSADAS (após transformações):",
        ])
        
        for chave, valor in resultado_predicao.get('features_preprocessadas', {}).items():
            linhas.append(f"  {chave}: {valor}")
    ...
    def diagnostico_erros(self, percentil: int = 95) -> pd.DataFrame:
        ...
        -------
        pd.DataFrame
            DataFrame com Valor_Real, Previsto, Erro_Absoluto, Erro_Percentual
        """
...
if __name__ == "__main__":
    ...
    try:
        print("⏳ Testando modelo com todas as amostras...")
        ...
        print("\n" + "=" * 70)
        print("EXEMPLO 1: PREDIÇÃO MANUAL COM FEATURES BRUTAS")
        print("=" * 70)
        
        exemplo_features_brutas = {
            'Brand': 'Toyota',
            'Model_Year': 2020,
            'Engine_Size': 2.0,
            'Fuel_Type': 'Diesel',
        ...
        resultado = tester.prever_manual(exemplo_features_brutas)
        ...
        # print("\n" + "=" * 70)
        # print("EXEMPLO 2: PREDIÇÃO INTERATIVA")
        # print("=" * 70)
